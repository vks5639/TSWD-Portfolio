...
|-------------------------|--------------------------------|-------------|-------------|
|  How does the storyboard/wireframe meet the needs of its intended audience? Did you notice any specific elements that add value to the information? | I think the storyboard is successful in helping me understand the nuances of the restaurant business.      |  he visual, the coloring, and the memorable stories of the two brothers. The charts made the argument more enticing.           |   clear who the audience is and it is a very niche story so that's good. liked the story approach to explain the concept         |
